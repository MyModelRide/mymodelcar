    ...
    <div className={style.wrapper} style={{ zIndex: 30 }}>
      ...
      <div className={style.btnContainer}>
        <button
          ...
          className="mr-4 md:mr-8 px-5 py-2 md:px-7 md:py-2 text-lg md:text-lg bg-white border-2 border-blue-600 text-blue-600 my-4 md:my-0"
        >
          {" "}
        ...
        <button
          ...
          className="mr-4 md:mr-8 px-5 py-2 md:px-7 md:py-2 text-lg md:text-lg bg-blue-600 border-2 border-blue-600 text-white my-4 md:my-0"
        >
          {" "}
